...
class Q03{
    ...
    public static void main(String[] args){
        ...
        while(!entrada.equals("FIM")){
            ...
            copia[id] = new Jogador();
            copia[id].clone(jogadores[id]);
        ...
        while(!entrada.equals("FIM")){
            ...
            for(int i=0;i<copia.length;i++){
                if(copia[i] != null){
                    comparacoes++;
                    if(copia[i].getNome().equals(entrada)){
                        comparacoes++;
                        resp = true;
                        break;
                    }
        ...
        matricula.openWrite("matricula_sequencial.txt");
        matricula.print("808674\t" + (System.currentTimeMillis()-tempoInicial)/1000.0 + "\t" + comparacoes);
        matricula.close();
